...
void test_pane_initialization() {
    ...
    test_assert(list->pane->lines == list->lines, "pane lines points to start of list");
...
void test_pane_after_adding_lines() {
    ...
    test_assert(list->pane->lines == list->lines, "pane lines still points to start");
    test_assert(strcmp(list->pane->lines[0], "line1") == 0, "pane can access added line");
    
    line_list_add(list, 5, "line2");
    line_list_add(list, 5, "line3");
    test_assert(list->pane->length == 3, "pane length reflects all lines");
    test_assert(strcmp(list->pane->lines[2], "line3") == 0, "pane can access last line");
...
void test_line_list_scroll_pane_basic() {
    ...
    test_assert(strcmp(list->pane->lines[0], "line2") == 0, "pane now starts at line2");
    ...
    test_assert(strcmp(list->pane->lines[0], "line4") == 0, "pane now starts at line4");
...
void test_pane_after_clear() {
    ...
    test_assert(list->pane->lines == list->lines, "clear resets pane lines pointer");
